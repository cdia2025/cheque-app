...
st.set_page_config(page_title="雲端實習津貼系統 (V63 搜尋不跳頁版)", layout="wide", page_icon="🛡️")
...
# 使用 Radio Button 模擬 Tabs (horizontal=True)
...
st.set_page_config(page_title="雲端實習津貼系統 (V62 穩定連線版)", layout="wide", page_icon="🛡️")
